...
void Vtop___024root___eval_debug_assertions(Vtop___024root* vlSelf) {
    ...
    if (VL_UNLIKELY((vlSelf->dcache_ready_i & 0xfeU))) {
        Verilated::overWidthError("dcache_ready_i");}
    if (VL_UNLIKELY((vlSelf->icache_data_valid_i & 0xfeU))) {
        Verilated::overWidthError("icache_data_valid_i");}
    if (VL_UNLIKELY((vlSelf->dcache_data_valid_i & 0xfeU))) {
        Verilated::overWidthError("dcache_data_valid_i");}
}
#endif  // VL_DEBUG
